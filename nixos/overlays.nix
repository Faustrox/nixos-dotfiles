...

{
  ...
  options = {
      overlays.gnome.setup = lib.mkEnableOption "Configure some patches overlays for Gnome";
      overlays.proton-pass.update = lib.mkEnableOption "update proton-pass to 1.22.2";
  };
