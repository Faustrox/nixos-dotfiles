  ...
  config = lib.mkIf config.hyprland.setup {
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        autogenerated = 0;
        source = [
          "/home/faustrox/.config/hypr/config/autostart.conf"
          "/home/faustrox/.config/hypr/config/keybindings.conf"
          "/home/faustrox/.config/hypr/config/nvidia.conf"
          "/home/faustrox/.config/hypr/config/rules.conf"
          "/home/faustrox/.config/hypr/themes/mocha.conf"
        ];
        monitor = [
