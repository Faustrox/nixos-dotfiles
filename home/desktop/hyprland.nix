    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        exec-once = [
          ...
          "uwsm app -s b -t service -- swww-daemon"
          "swww img $HOME/Pictures/Wallpapers/nix-catppuccin-alt.png"
          "uwsm app -s b -t service -- clipse -listen"
          "uwsm app -s b -t service -- wl-clip-persist --clipboard regular"
          "$HOME/.config/hypr/scripts/vrr-workaround.sh"
          "sleep 3 && uwsm app -s b -t service -- $HOME/.scripts/start.sh"

          "[workspace 1 silent] uwsm app -s b -- firefox"
          "[workspace 5 silent] uwsm app -s b -- telegram-desktop"
